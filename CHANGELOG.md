...
### Added
- Alignment guides while arranging: dragging a widget shows guides for its display's edges and centre and for other widgets' edges, and releasing snaps it onto the nearest one.
